...
Note that an SWIP number will be assigned by an editor. When opening a pull request to submit your SWIP, please use an abbreviated title in the filename, `SWIP-draft_title_abbrev.md`.
...
## Test Cases
<!--Test cases for an implementation are mandatory for SWIPs that are affecting consensus changes. Other SWIPs can choose to include links to test cases if applicable.-->
Test cases for an implementation are mandatory for SWIPs that are affecting consensus changes. Other SWIPs can choose to include links to test cases if applicable.
