...
If the imbalance in the swap channel results from high variance as opposeed to unequal consumption, it will happen that, after a period of accumulating cheques the channel balance starts tilting the other way. Nominally it is now up to the other party to issue cheques to its peer resulting an uncashed cheques accumulating on both sides.
